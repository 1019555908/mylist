  ...
  <div>
    <div class="home">
      <div class="bottomfixed">
        <header style="width:100%;">
          <div class="inp">
            <div class="zz">
              <van-cell is-link @click="showPopup" style="    width: 100px;
    height: 45px;">
                <span
                  style="width: 100px;
    position: absolute;
    ...
    font-size: 20px;"
          ...
          <van-tabs class="toptab" v-model="active" @click="onClick">
            <img
              style="width:74px;height:40px; float:left;"
              src="https://image2.benlailife.com/AppHomePageImageb01ad94e-45bb-41f4-b1e8-726614ba77ea.gif"
              alt
            />
            <!-- 顶部tab切换部分 -->
            <van-tab
...
.inp :nth-child(2) input {
    ...
    color: #000;
    background: url(//image.benlailife.com/static/images/top/top_new_c262d734.png) no-repeat #f3f3f3;
